...
#define  PANEL_RB                         8       /* callback function: ExitDialog */
#define  PANEL_RB_SAV_HI                  2
#define  PANEL_RB_UNLOCKY                 3
#define  PANEL_RB_LOCKY                   4
#define  PANEL_RB_CURR_POS_X              5
#define  PANEL_RB_CURR_POS_Y              6
#define  PANEL_RB_DECORATION_30           7
#define  PANEL_RB_DECORATION_5            8
#define  PANEL_RB_MOT_ADJ_U               9       /* callback function: RobotManuAdj */
#define  PANEL_RB_MOT_ADJ_D               10      /* callback function: RobotManuAdj */
#define  PANEL_RB_MOT_ADJ_L               11      /* callback function: RobotManuAdj */
#define  PANEL_RB_MOT_ADJ_LL              12      /* callback function: RobotManuAdj */
#define  PANEL_RB_MOT_ADJ_R               13      /* callback function: RobotManuAdj */
#define  PANEL_RB_MOT_ADJ_RR              14      /* callback function: RobotManuAdj */
#define  PANEL_RB_MOT_ADJ_UU              15      /* callback function: RobotManuAdj */
#define  PANEL_RB_MOT_ADJ_DD              16      /* callback function: RobotManuAdj */
#define  PANEL_RB_FORCE_STOP              17
#define  PANEL_RB_TEXTMSG_27              18
#define  PANEL_RB_TEXTMSG_28              19
#define  PANEL_RB_TEXTMSG_23              20
#define  PANEL_RB_TEXTMSG_24              21
#define  PANEL_RB_UNLOCKX                 22
#define  PANEL_RB_LOCKX                   23
#define  PANEL_RB_CHECKBOX_2              24      /* callback function: ManualInput */
#define  PANEL_RB_CHECKBOX                25      /* callback function: ManualInput */
#define  PANEL_RB_CMD_GET                 26      /* callback function: RobotCommand */
#define  PANEL_RB_CMD_PUT                 27      /* callback function: RobotCommand */
#define  PANEL_RB_CMD_HOME                28      /* callback function: RobotCommand */
#define  PANEL_RB_CMD_CLEAN               29      /* callback function: RobotCommand */
#define  PANEL_RB_CMD_MOVE                30      /* callback function: RobotCommand */
#define  PANEL_RB_RING                    31      /* callback function: tankChange */
#define  PANEL_RB_TEXTMSG_31              32
#define  PANEL_RB_TEXTMSG_30              33
#define  PANEL_RB_TEXTMSG_29              34
#define  PANEL_RB_TEXTMSG_22              35
#define  PANEL_RB_DECORATION_28           36
#define  PANEL_RB_DECORATION_29           37
#define  PANEL_RB_SET_LCK                 38      /* callback function: SavePosition */
#define  PANEL_RB_BUBB_LAB                39
#define  PANEL_RB_SET_POS                 40      /* callback function: SavePosition */
#define  PANEL_RB_SHUT_LAB                41
#define  PANEL_RB_SET_SAV_HI              42      /* callback function: SavePosition */
#define  PANEL_RB_SPLITTER                43
#define  PANEL_RB_TIMER                   44      /* callback function: RobotTimer */
#define  PANEL_RB_FILL_LAB                45
#define  PANEL_RB_CHUCK_OFF               46      /* callback function: RobotCommand */
#define  PANEL_RB_CHUCK_ON                47      /* callback function: RobotCommand */
#define  PANEL_RB_TEACH_OFF               48      /* callback function: RobotCommand */
#define  PANEL_RB_TEACH_ON                49      /* callback function: RobotCommand */
#define  PANEL_RB_FILL_OFF                50      /* callback function: RobotCommand */
#define  PANEL_RB_FILL_ON                 51      /* callback function: RobotCommand */

#define  PANEL_RCP                        9       /* callback function: ExitDialog */
...
#define  PANEL_SET                        10      /* callback function: ExitDialog */
...
#define  PANEL_TANK                       12      /* callback function: ExitDialog */
...
#define  PANEL_USER                       13      /* callback function: ExitDialog */
