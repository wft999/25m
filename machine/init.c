...
void configTankData(void)
{
	...
	strcpy(sys->tk[TANK_02].name,"SC");
	strcpy(sys->tk[TANK_03].name,"HDIW1");
	strcpy(sys->tk[TANK_04].name,"TEX1");
	strcpy(sys->tk[TANK_05].name,"TEX2");
	strcpy(sys->tk[TANK_06].name,"HDIW2");
	strcpy(sys->tk[TANK_07].name,"TEX3");
...
//	sys->tk[TANK_15].hsShutClose.wid = 5; sys->tk[TANK_15].hsShutClose.bid = 8;
	...
	sys->tk[TANK_02].hsMMakeStop.wid = 15; sys->tk[TANK_02].hsMMakeStop.bid = 0;
	sys->tk[TANK_04].hsMMakeStop.wid = 15; sys->tk[TANK_04].hsMMakeStop.bid = 1;
	sys->tk[TANK_07].hsMMakeStop.wid = 15; sys->tk[TANK_07].hsMMakeStop.bid = 2;
	sys->tk[TANK_11].hsMMakeStop.wid = 15; sys->tk[TANK_11].hsMMakeStop.bid = 3;
	
	sys->tk[TANK_02].hsMakeStop.wid = 14; sys->tk[TANK_02].hsMakeStop.bid = 11;
	sys->tk[TANK_04].hsMakeStop.wid = 14; sys->tk[TANK_04].hsMakeStop.bid = 12;
	sys->tk[TANK_07].hsMakeStop.wid = 14; sys->tk[TANK_07].hsMakeStop.bid = 13;
	sys->tk[TANK_11].hsMakeStop.wid = 14; sys->tk[TANK_11].hsMakeStop.bid = 14;
